...
## [0.10.0](https://github.com/barisgit/agent-desktop/compare/v0.9.4...v0.10.0) (2026-09-23)
...
* verify stateful ref actions against fresh platform state ([9bc91bc](https://github.com/barisgit/agent-desktop/commit/9bc91bc0ab53139d85e5c10a0ae0b3c3b4bc18b9))


### Bug Fixes

* add 'someone' to Windows path allowlist in gitleaks config ([95ca2cc](https://github.com/barisgit/agent-desktop/commit/95ca2ccb489a6a6fcf4b8cecb05d483498391e0f))
...
* add me and someone to Windows path allowlist in gitleaks config ([aa0ab0f](https://github.com/barisgit/agent-desktop/commit/aa0ab0fb3c7bbe48593ab09b756cff809e5ce967))
...
* allow 'someone' placeholder in Windows path allowlist ([f23d486](https://github.com/barisgit/agent-desktop/commit/f23d48646cec0d7e91fc2bf1fb7d635917e064cf))
* allow 'someone' placeholder in Windows path allowlist ([0e5a0b7](https://github.com/barisgit/agent-desktop/commit/0e5a0b7678e5715fa4d1402f96dfcc1bf8c5310a))
...
* apply rustfmt to new scenario test files ([ff63313](https://github.com/barisgit/agent-desktop/commit/ff633136cfa38701a6cf3e744d94f5dfff5553ac))
* clear remembered cursor landing when the overlay is hidden ([6adff7a](https://github.com/barisgit/agent-desktop/commit/6adff7af0f50344924f8e8874be72ded1b72a8b3))
...
* **cursor:** gate agent_id stamping on multi-agent mode ([58612ea](https://github.com/barisgit/agent-desktop/commit/58612eac673a45634e00a651872da043297e68d3))
...
* **drag:** scope --wait-for to the drop target by default with --wait-for-scope from|to ([cefc80a](https://github.com/barisgit/agent-desktop/commit/cefc80a89c95b21061573e366e3832bff6baa231))
* extend Windows path allowlist to cover 'me' and 'someone' placeholders ([6c60c4d](https://github.com/barisgit/agent-desktop/commit/6c60c4d1fea6f44829a9ef81c6b3eeb59bbb3625))
* guard the debug viewer image sink and unpin a flaky test deadline ([fca24f2](https://github.com/barisgit/agent-desktop/commit/fca24f2b0259bac83ff17a490052e1f2a9a9496f))
...
* harden native accessibility targeting and delivery ([#210](https://github.com/barisgit/agent-desktop/issues/210)) ([882c4c4](https://github.com/barisgit/agent-desktop/commit/882c4c4695c0db7d75b83f2655ece178591deb6c))
...
* make headless desktop actions report what actually happened, and add jev-desktop ([#206](https://github.com/barisgit/agent-desktop/issues/206)) ([0691eba](https://github.com/barisgit/agent-desktop/commit/0691eba25f6a7082b197bc73ad5daa0e3315c976))
* preserve wait_timeout envelope when inherited deadline expires ([07913a7](https://github.com/barisgit/agent-desktop/commit/07913a7cdb85d79e1708063fd398c9f8571894e9))
* prevent wait --count false positives on incomplete snapshots ([319e9c6](https://github.com/barisgit/agent-desktop/commit/319e9c6c2e7c175fdec42d19b2f1614b9238a909))
* reject percent-encoded NUL in file URLs; extend gitleaks Windows path allowlist ([ec85b30](https://github.com/barisgit/agent-desktop/commit/ec85b3047ffe9c3f9686494d4a337c7086cc6779))
* reject percent-encoded NUL in file_url_to_path ([de5df38](https://github.com/barisgit/agent-desktop/commit/de5df38ede3d45ed7e4d438e732724972351dbe4))
* reject percent-encoded NUL in file_url_to_path ([768a643](https://github.com/barisgit/agent-desktop/commit/768a6431a8723cf75afdebef9ec1940287fe49f0))
* reject percent-encoded NUL in file_url_to_path ([d8ebed0](https://github.com/barisgit/agent-desktop/commit/d8ebed0ebefd191d6973931b3d7f66643d9a16cd))
...
* report unread expand state as unverified rather than failed ([a7131c2](https://github.com/barisgit/agent-desktop/commit/a7131c241cce06687b15c53386fd7787d8fbfd72))
...
* restore cursor overlay lifecycle for keyboard and clipboard actions ([c827cf9](https://github.com/barisgit/agent-desktop/commit/c827cf96560629265ea34451a1a66fe839adab8f))
...
* skip ended-session batch entries before wait baseline pre-capture ([899ce27](https://github.com/barisgit/agent-desktop/commit/899ce2702a68716a7704b7403050dd7f54161208))
* split acronym boundaries in trace key redaction ([3042e0c](https://github.com/barisgit/agent-desktop/commit/3042e0c7a823508fd5417584f0459d428832c8a0))
* split wait_scenario_tests.rs to satisfy 400-line file limit ([f2435b5](https://github.com/barisgit/agent-desktop/commit/f2435b5bb940d137585bd71021475176d36dafbd))
...
* stop the inspector shutdown test failing on an expected reset ([22cad9e](https://github.com/barisgit/agent-desktop/commit/22cad9ec21136562ed191a8cfb827dc22378c554))
...
* sync cargo lock with the 0.9.3 release ([#217](https://github.com/barisgit/agent-desktop/issues/217)) ([8c1502e](https://github.com/barisgit/agent-desktop/commit/8c1502e43c6c78fe856980f0bb7b3585f877d347))
