...
#[cfg(target_os = "macos")]
pub(crate) fn try_simple_key_action(
...
#[cfg(target_os = "macos")]
pub(crate) fn try_menu_bar_shortcut(
...
#[cfg(target_os = "macos")]
pub(crate) fn read_menu_item_modifiers(el: &crate::tree::AXElement) -> u32 {
...
#[cfg(target_os = "macos")]
pub(crate) fn combo_to_ax_modifiers(combo: &KeyCombo) -> u32 {
    let mut mods: u32 = 0;
...
#[cfg(target_os = "macos")]
pub(crate) fn ax_post_keyboard_event(
    app_el: accessibility_sys::AXUIElementRef,
    combo: &KeyCombo,
) -> Result<(), AdapterError> {
...
#[cfg(target_os = "macos")]
pub(crate) fn key_to_keycode(key: &str) -> Option<u16> {
    Some(match key {
        "a" => 0,
        "b" => 11,
        "c" => 8,
